const genItem = () => [
    {
        ...
        guideline:
            <ol>
                ...
                <li>Sort and recycle the plastic bottle caps, paper and bottle bodies and put them in the plastic
                    recycling bin
                </li>
            </ol>
    }, {
        ...
        guideline:
            <ol>
                <li>Request the seller to deliver the new item and remove the old item of the same class on the same day
        ...
        guideline:
            <ol>
                <li>Before placing used lamps in the collection box for recycling, place them in the packaging that
                    comes with new lamps.
                </li>
        ...
        guideline:
            <ol>
                ...
                <li> For batteries that are vulnerable to damage, put them in plastic bag and seal them with adhesive
                    tape before deposit.
                </li>
